...
rm -f build/libs/tcpping.jar

mv build/libs/tcpping-all.jar build/libs/tcpping.jar
...
jpackage --type pkg --input build/libs --main-jar tcpping.jar --name tcpping --app-version 1.0.0
